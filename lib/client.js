...
let _starsinc1708_dsh_tool_council_types = require("@starsinc1708/dsh-tool-council/types");
...
function isArtifact(meta) {
	...
	return candidate.kind === _starsinc1708_dsh_tool_council_types.COUNCIL_ARTIFACT_KIND && candidate.version === _starsinc1708_dsh_tool_council_types.COUNCIL_ARTIFACT_VERSION && typeof candidate.runId === "string" && Array.isArray(candidate.rows);
}
