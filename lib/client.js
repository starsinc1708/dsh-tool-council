...
const css$1 = ".dshc_563f85 { display: flex; flex-direction: column; gap: 14px; }\n\n.dshc_ef8885 { display: flex; flex-direction: column; gap: 2px; }\n.dshc_ab44de { display: flex; align-items: baseline; gap: 8px; }\n.dshc_ef8885 h3 { margin: 0; font-size: 14px; font-weight: 600; }\n.dshc_bcf251 {\n  font-size: 10px; font-style: normal; padding: 1px 7px; border-radius: 999px;\n  color: var(--dsh-warning, #b26500);\n  background: color-mix(in srgb, var(--dsh-warning, #b26500) 14%, transparent);\n}\n.dshc_2903bc { margin: 0; font-size: 12px; opacity: 0.7; line-height: 1.5; }\n.dshc_838b53 { padding: 12px; font-size: 12px; opacity: 0.7; }\n\n.dshc_2740c3 { display: flex; align-items: center; gap: 8px; font-size: 12px; }\n.dshc_2740c3 > span { opacity: 0.7; }\n.dshc_2740c3 select { flex: 0 0 auto; }\n.dshc_198abb { width: 90px; }\n\n.dshc_2d1d8a { display: flex; flex-wrap: wrap; gap: 4px; }\n.dshc_316ee1, .dshc_999979 {\n  padding: 3px 10px; border-radius: 999px; font-size: 12px; cursor: pointer;\n  border: 1px solid var(--dsh-border, rgb(0 0 0 / 15%)); background: transparent; color: inherit;\n}\n.dshc_999979 { border-color: transparent; background: var(--dsh-accent-soft, rgb(0 0 0 / 8%)); font-weight: 600; }\n\n.dshc_a7671b { display: flex; flex-direction: column; gap: 10px; }\n.dshc_9f3a2b {\n  margin: 0; align-self: flex-start; font-size: 11px; padding: 2px 8px; border-radius: 999px;\n  opacity: 0.75; font-variant-numeric: tabular-nums;\n  background: var(--dsh-accent-soft, rgb(0 0 0 / 6%));\n}\n\n.dshc_9779c2 {\n  margin: 0; padding: 4px 12px 12px; border-radius: 8px;\n  border: 1px solid var(--dsh-border, rgb(0 0 0 / 12%));\n  display: flex; flex-direction: column; gap: 10px;\n}\n.dshc_9779c2 legend {\n  padding: 0 6px; font-size: 10px; font-weight: 600;\n  text-transform: uppercase; letter-spacing: 0.06em; opacity: 0.55;\n}\n\n/* Two stacked bands per role: the name, then a fixed three-column field grid.\n   The fields therefore align down the whole layer instead of each row wrapping\n   at a different point, which is what made the card look ragged. */\n.dshc_fa2fe2 { display: flex; flex-direction: column; gap: 5px; }\n.dshc_fa2fe2 + .dshc_fa2fe2 { padding-top: 10px; border-top: 1px solid var(--dsh-border, rgb(0 0 0 / 8%)); }\n.dshc_cfe39e { display: flex; align-items: center; gap: 6px; min-height: 18px; }\n.dshc_c9bd5c { font-size: 12px; font-weight: 500; }\n\n.dshc_65d340 {\n  font-size: 10px; font-style: normal; padding: 0 6px; border-radius: 999px;\n  opacity: 0.85; background: var(--dsh-accent-soft, rgb(0 0 0 / 8%));\n}\n.dshc_b04b7b {\n  font-size: 10px; padding: 0 7px; border-radius: 999px; cursor: pointer; color: inherit;\n  border: 1px solid var(--dsh-border, rgb(0 0 0 / 15%)); background: transparent;\n}\n.dshc_b04b7b:hover:not(:disabled) { background: var(--dsh-accent-soft, rgb(0 0 0 / 8%)); }\n\n.dshc_f01cc7 { display: grid; grid-template-columns: 68px minmax(0, 1fr) minmax(0, 1fr); gap: 8px; }\n.dshc_54424c, .dshc_04469f { display: flex; flex-direction: column; gap: 2px; min-width: 0; }\n.dshc_04469f { grid-column: span 2; }\n.dshc_54424c > span, .dshc_04469f > span {\n  font-size: 10px; text-transform: uppercase; letter-spacing: 0.04em; opacity: 0.55;\n}\n.dshc_54424c input, .dshc_04469f input, .dshc_04469f select {\n  width: 100%; min-width: 0; box-sizing: border-box; font-size: 12px;\n}\n\n/* One column below the settings panel's narrow breakpoint, so nothing is ever\n   squeezed to an unusable width. */\n@media (max-width: 460px) {\n  .dshc_f01cc7 { grid-template-columns: minmax(0, 1fr); }\n  .dshc_04469f { grid-column: auto; }\n}\n\n.dshc_85cc84 { font-size: 12px; }\n.dshc_85cc84 summary { cursor: pointer; opacity: 0.7; }\n.dshc_06b2b1 {\n  width: 100%; margin-top: 6px; box-sizing: border-box; resize: vertical;\n  font-family: var(--dsh-font-mono, ui-monospace, monospace); font-size: 11px;\n}\n.dshc_bf9bd6 { display: flex; align-items: center; flex-wrap: wrap; gap: 8px; margin-top: 6px; }\n.dshc_9d875e { font-size: 11px; opacity: 0.7; }\n\n.dshc_07bf2b { margin: 0; font-size: 12px; color: var(--dsh-danger, #c0392b); }\n\n.dshc_9c7bdb { display: flex; align-items: center; gap: 8px; }\n.dshc_529d95 { flex: 1 1 auto; }\n";
...
var CouncilCard_module_css_default = {
	...
	"empty": "dshc_838b53",
	"row": "dshc_2740c3",
	"costInput": "dshc_198abb",
	"tabs": "dshc_2d1d8a",
	"tab": "dshc_316ee1",
	"tabSelected": "dshc_999979",
	"layers": "dshc_a7671b",
	"total": "dshc_9f3a2b",
	"layer": "dshc_9779c2",
	"role": "dshc_fa2fe2",
	"roleName": "dshc_cfe39e",
	"roleLabel": "dshc_c9bd5c",
	"badge": "dshc_65d340",
	"revert": "dshc_b04b7b",
	"roleFields": "dshc_f01cc7",
	"field": "dshc_54424c",
	"fieldWide": "dshc_04469f",
	"transfer": "dshc_85cc84",
	"transferBox": "dshc_06b2b1",
	"transferRow": "dshc_bf9bd6",
	"transferNote": "dshc_9d875e",
	"error": "dshc_07bf2b",
	"foot": "dshc_9c7bdb",
	"spacer": "dshc_529d95"
};
...
const css = ".dshc_11a4dc { display: flex; flex-direction: column; gap: 20px; padding: 16px; overflow: auto; }\n.dshc_ca127b { padding: 24px 16px; font-size: 12px; opacity: 0.6; }\n.dshc_e4b928 { margin: 0; font-size: 12px; opacity: 0.65; }\n.dshc_ab01b9 { margin: 0; font-size: 11px; opacity: 0.5; line-height: 1.5; }\n.dshc_8525d1 { margin: 0; font-size: 12px; color: var(--dsh-warning, #b26500); }\n.dshc_72b554 { flex: 1 1 auto; }\n\n.dshc_08f368 { display: flex; flex-direction: column; gap: 10px; }\n.dshc_3b1a6f { display: flex; flex-direction: column; gap: 10px; padding-top: 10px; }\n.dshc_458697 { display: flex; align-items: center; gap: 10px; cursor: pointer; }\n.dshc_a3549a { font-size: 13px; font-weight: 600; flex: none; }\n.dshc_61e555 {\n  font-size: 12px; opacity: 0.65; min-width: 0; flex: 1 1 auto;\n  overflow: hidden; text-overflow: ellipsis; white-space: nowrap;\n}\n.dshc_c68ff5, .dshc_50ca93 {\n  font-size: 10px; padding: 1px 7px; border-radius: 999px; flex: none; text-transform: uppercase;\n  letter-spacing: 0.04em;\n}\n.dshc_c68ff5 {\n  color: var(--dsh-warning, #b26500);\n  background: color-mix(in srgb, var(--dsh-warning, #b26500) 14%, transparent);\n}\n.dshc_50ca93 {\n  color: var(--dsh-danger, #c0392b);\n  background: color-mix(in srgb, var(--dsh-danger, #c0392b) 14%, transparent);\n}\n.dshc_12588b { font-size: 11px; text-transform: uppercase; letter-spacing: 0.04em; opacity: 0.6; }\n.dshc_60ff67 { font-size: 11px; opacity: 0.5; font-variant-numeric: tabular-nums; flex: none; }\n.dshc_d405fd { margin: 0; font-size: 12px; font-variant-numeric: tabular-nums; }\n.dshc_06171b {\n  margin: 0; padding-left: 16px; font-size: 12px; opacity: 0.75;\n  font-variant-numeric: tabular-nums; display: flex; flex-direction: column; gap: 2px;\n}\n\n.dshc_1b9c12 { display: flex; gap: 10px; align-items: stretch; overflow-x: auto; }\n.dshc_e24045 {\n  flex: 1 1 0; min-width: 180px; margin: 0; padding: 8px 10px 10px; border-radius: 8px;\n  border: 1px solid var(--dsh-border, rgb(0 0 0 / 12%));\n}\n.dshc_e24045 legend { padding: 0 4px; font-size: 11px; text-transform: uppercase; letter-spacing: 0.04em; opacity: 0.7; }\n.dshc_72987d {\n  display: flex; gap: 8px; font-size: 11px; opacity: 0.5;\n  font-variant-numeric: tabular-nums; min-height: 1em;\n}\n\n.dshc_55a046 { display: flex; flex-direction: column; gap: 3px; padding: 6px 0; border-top: 1px solid var(--dsh-border, rgb(0 0 0 / 8%)); }\n.dshc_55a046:first-of-type { border-top: none; }\n.dshc_9e36ae { display: flex; align-items: center; gap: 6px; font-size: 12px; }\n.dshc_fbcb22 { font-weight: 500; }\n.dshc_5374e0 { font-size: 11px; opacity: 0.6; margin-left: auto; }\n.dshc_83d87c { font-size: 11px; opacity: 0.5; font-variant-numeric: tabular-nums; }\n.dshc_768c50 { margin: 0; font-size: 11px; opacity: 0.55; line-height: 1.4; }\n\n.dshc_100988 { width: 8px; height: 8px; border-radius: 50%; flex: none; background: var(--dsh-muted, rgb(0 0 0 / 15%)); }\n.dshc_100988[data-status='completed'] { background: var(--dsh-success, #2e7d32); }\n.dshc_100988[data-status='running'] { background: var(--dsh-info, #1565c0); animation: pulse 1.2s ease-in-out infinite; }\n.dshc_100988[data-status='failed'] { background: var(--dsh-danger, #c62828); }\n.dshc_100988[data-status='cancelled'], .dshc_100988[data-status='interrupted'] { background: var(--dsh-warning, #ef6c00); }\n\n@keyframes pulse { 0%, 100% { opacity: 1; } 50% { opacity: 0.3; } }\n\n.dshc_715a40 { display: flex; flex-direction: column; gap: 8px; }\n.dshc_91ba2d { display: flex; align-items: center; gap: 8px; }\n.dshc_91ba2d h4 { margin: 0; font-size: 12px; text-transform: uppercase; letter-spacing: 0.04em; opacity: 0.7; }\n.dshc_715a40 h4 { margin: 0; font-size: 12px; text-transform: uppercase; letter-spacing: 0.04em; opacity: 0.7; }\n.dshc_91ba2d button { font-size: 11px; padding: 2px 8px; }\n\n.dshc_8e29c9 {\n  align-self: flex-start; font-size: 11px; padding: 2px 8px; border-radius: 999px;\n  cursor: pointer; color: inherit; background: transparent;\n  border: 1px solid var(--dsh-border, rgb(0 0 0 / 15%));\n}\n\n.dshc_a4cbff { overflow-x: auto; }\n.dshc_95b246 { border-collapse: collapse; font-size: 12px; width: 100%; }\n.dshc_95b246 th, .dshc_95b246 td {\n  border: 1px solid var(--dsh-border, rgb(0 0 0 / 12%));\n  padding: 4px 8px; text-align: left; vertical-align: top;\n}\n.dshc_95b246 th { font-weight: 500; opacity: 0.7; white-space: nowrap; }\n.dshc_ab0914 { caption-side: top; text-align: left; font-size: 11px; opacity: 0.55; padding-bottom: 4px; }\n.dshc_377e56 { font-weight: 400; opacity: 0.6; text-align: right; }\n/* Long titles and fixes wrap instead of forcing the table wider than the tab. */\n.dshc_95b246 td:nth-child(2), .dshc_95b246 td:last-child { max-width: 22em; overflow-wrap: anywhere; }\n.dshc_95b246 tr[data-outcome='confirmed'] td { background: color-mix(in srgb, var(--dsh-success, #2e7d32) 8%, transparent); }\n.dshc_95b246 tr[data-outcome='insufficient'] td { opacity: 0.65; }\n.dshc_d777d3 { text-align: center; white-space: nowrap; }\n.dshc_f14cce { font-family: var(--dsh-font-mono, ui-monospace, monospace); white-space: nowrap; }\n\n.dshc_20a364 {\n  margin: 0; padding: 10px 12px; border-radius: 8px; font-size: 12px; line-height: 1.5;\n  white-space: pre-wrap; overflow-x: auto;\n  border: 1px solid var(--dsh-border, rgb(0 0 0 / 12%));\n}\n";
...
var council_view_module_css_default = {
	...
	"runName": "dshc_a3549a",
	"runTask": "dshc_61e555",
	"chipWarn": "dshc_c68ff5",
	"chipDanger": "dshc_50ca93",
	"runStatus": "dshc_12588b",
	"runMeta": "dshc_60ff67",
	"runSummary": "dshc_d405fd",
	"runLog": "dshc_06171b",
	"layers": "dshc_1b9c12",
	"layer": "dshc_e24045",
	"layerMeta": "dshc_72987d",
	"member": "dshc_55a046",
	"memberRow": "dshc_9e36ae",
	"memberLabel": "dshc_fbcb22",
	"memberStatus": "dshc_5374e0",
	"memberTokens": "dshc_83d87c",
	"memberHint": "dshc_768c50",
	"dot": "dshc_100988",
	"outcome": "dshc_715a40",
	"outcomeHead": "dshc_91ba2d",
	"showAll": "dshc_8e29c9",
	"tableWrap": "dshc_a4cbff",
	"table": "dshc_95b246",
	"caption": "dshc_ab0914",
	"rowIndex": "dshc_377e56",
	"vote": "dshc_d777d3",
	"mono": "dshc_f14cce",
	"report": "dshc_20a364"
};
