...
const en = {
	...
	"designer.editPrompt": "tune this role’s prompt",
	"designer.promptTunePlaceholder": "Tuned prompt for this role (only this session)…",
	"designer.promptTuneHint": "Clearing the text restores the preset’s original prompt.",
...
const zh = {
	...
	"designer.edit": "编辑视角",
	"designer.editPrompt": "微调此角色的提示词",
	"designer.promptTunePlaceholder": "此角色的微调提示词（仅本会话）…",
	"designer.promptTuneHint": "清空文本即可恢复预设的原始提示词。",
...
*/
function setPromptTune(draft, key, prompt) {
	const roles = { ...draft.roles };
	const entry = { ...roles[key] };
...
function projectSetup(preset, draft) {
	...
	for (const [key, tune] of Object.entries(draft.roles)) {
		...
		if (tune.prompt !== void 0 && tune.prompt.trim() !== "") out.prompt = tune.prompt;
...
var SessionCouncilController = class {
	...
	async save() {
		...
		if (this.snapshot.customError !== void 0) {
			this.error = this.partialSaveMessage(this.snapshot.customError);
			this.publish();
			return;
		}
		if (this.snapshot.widthViolations.length > 0 || this.snapshot.quorumViolation !== void 0) {
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					children: node.roles.map((row) => {
						...
						return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(RoleRow, {
							...
							overridePrompt: editable ? void 0 : draft.roles[row.key]?.prompt ?? "",
							onPromptOverride: editable ? void 0 : (text) => {
								actions.setPrompt(row.key, text);
							}
						}, row.key);
					})
				}),
...
function RoleRow(props) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			!editable ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
			...
			!editing ? null : editable ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(AuthoredRoleForm, {
				initialLabel: row.label,
				initialPrompt: row.prompt ?? "",
				onPatch: sink.patch,
				t
			}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PromptTuneForm, {
...
function PromptTuneForm(props) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("textarea", {
			...
			className: session_council_module_css_default.hint,
			children: t("designer.promptTuneHint")
		})]
	});
}
/**
