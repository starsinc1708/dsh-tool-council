...
function composePreset(source, rows, sourceId) {
	...
	return [
		`# GENERATED by @deepseek-ai/dsh-tool-council — derived from the "${sourceId}" preset.`,
		"#",
...
function apply(ctx, config) {
	...
	const options = {
		...
		rows: composeRows(config.presetPluginName ?? "@deepseek-ai/dsh-tool-council/tool", toolConfigOf(config.councilPolicy))
	};
	ctx.effect(() => {
		let disposed = false;
