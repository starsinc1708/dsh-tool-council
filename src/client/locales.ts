...
export const en = {
  ...
  'designer.verifySkipped': 'Verification is off for this session: runs go straight from the examining '
    + 'layer to the synthesizer, so nothing is cross-checked before it is reported.',
  ...
  'designer.widthExceeded': 'Layer "{layer}" of preset "{preset}" would start {width} members; this '
    + 'deployment allows {max}.',
  ...
  'designer.promptSeed': 'Focus your lens on: {role}. Read the workspace, run what you can, and report '
    + 'only what you verified — with a concrete `path:line` location and observed evidence.',
  ...
  'custom.reduceSeed': 'You write the final report from what the members and verifiers produced: the question, '
    + 'what is established and what remains unknown. Attribute conclusions to the council, not to certainty.',
...
export const zh: typeof en = {
  ...
  'designer.promptSeed': '将你的视角聚焦于：{role}。阅读工作区、尽量运行验证，只报告你亲自核实的内容——'
    + '附上具体的 `path:line` 位置与观察到的证据。',
  ...
  'custom.reduceSeed': '你根据成员与复核者产出的内容撰写最终报告：问题、已确证内容与仍属未知的内容。'
    + '结论归因于议事会，而非确定无疑。',
